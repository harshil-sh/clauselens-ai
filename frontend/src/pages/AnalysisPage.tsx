  ...
  if (query.isLoading) {
    return (
      <EmptyState
        ...
        description="Fetching document summary, clauses, and risks."
      />
    );
  }
  ...
  if (query.isError || !query.data) {
    return (
      <EmptyState
        ...
        description={query.error instanceof Error ? query.error.message : "The requested analysis could not be loaded."}
        action={
    ...
    <section className="page-section analysis-page">
      ...
      <div className="analysis-page__hero">
        <Card className="analysis-page__summary-card">
          ...
          {summaryText ? (
            <p className="analysis-page__summary-lede">{summaryText}</p>
          ) : (
            <EmptyState
              title="No summary returned"
              description="This analysis completed without a short summary for the document."
            />
          )}
      ...
      <Card>
        ...
        {clauseGroups.length > 0 ? (
          ...
          <EmptyState
            ...
            description="The analysis completed, but no structured clauses were returned for this document."
          />
        )}
      </Card>
      ...
      <Card>
        ...
        {analysis.risk_flags.length > 0 ? (
          ...
          <EmptyState
            title="No risk flags detected"
            description={
              <>
                No structured risks were returned for this document. <Link to="/">Analyse another file</Link>.
              </>
            }
          />
        )}
